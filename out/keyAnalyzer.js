...
exports.KeyAnalyzer = void 0;
const vscode = require("vscode");
const fs = require("fs");
const path = require("path");
const glob = require("fast-glob");
const dictParsers_1 = require("./parsers/dictParsers");
class KeyAnalyzer {
    constructor(config, workspaceRoot) {
        this.config = config;
        this.workspaceRoot = workspaceRoot;
        this.parserManager = new dictParsers_1.DictParserManager();
    }
    /**
     * 分析Key状态
     */
    async analyzeKeys(cache) {
        // 扫描原始语种字典
     ...
     * 更新缓存中的源文件信息
     */
    updateSourceFileInfo(cache, keyToFiles) {
...
exports.KeyAnalyzer = KeyAnalyzer;
//# sourceMappingURL=keyAnalyzer.js.map